    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center">
          ...
          {/* Name */}
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-black mb-4 tracking-tight leading-none">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 mb-8">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">Monthly Listeners</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl font-bold text-[#d4af37]">50+</p>
              <p className="text-xs text-gray-500 mt-1">Songs Released</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl font-bold text-[#d4af37]">
                10M+
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500 mt-1">Live Shows</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-8">
            <a
              href="#music"
              className="inline-flex items-center gap-2 bg-gradient-gold text-black px-8 py-3 rounded-full font-semibold hover:scale-105 transition-transform"
            >
              <Play size={18} />
              Listen Now
            </a>
