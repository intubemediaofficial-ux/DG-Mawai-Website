...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative overflow-hidden px-6 pt-28 pb-20 sm:px-8 sm:pt-36 sm:pb-32">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          <div className="order-2 text-center lg:order-1 lg:text-left">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg leading-9 text-gray-300 sm:text-xl lg:mx-0">
              {content.hero.tagline}
            </p>

            <div className="mt-10 grid grid-cols-2 gap-5 sm:grid-cols-4 lg:max-w-2xl">
